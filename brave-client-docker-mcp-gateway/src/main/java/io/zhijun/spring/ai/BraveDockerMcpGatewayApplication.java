...
public class BraveDockerMcpGatewayApplication {
    private static final Logger log = LoggerFactory.getLogger(BraveDockerMcpGatewayApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(BraveDockerMcpGatewayApplication.class, args);
    }
