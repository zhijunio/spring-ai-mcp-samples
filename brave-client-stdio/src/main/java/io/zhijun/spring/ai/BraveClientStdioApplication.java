...
public class BraveClientStdioApplication {
    private static final Logger log = LoggerFactory.getLogger(BraveClientStdioApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(BraveClientStdioApplication.class, args);
    }
