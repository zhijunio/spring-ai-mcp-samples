...
public class WeatherClientWebFluxApplication {
    private static final Logger log = LoggerFactory.getLogger(WeatherClientWebFluxApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(WeatherClientWebFluxApplication.class, args);
    }
